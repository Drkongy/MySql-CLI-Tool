...
module.exports = {
    name: 'create',
    description: 'Creates a new sql table',
    execute(message, args, rl) {
        ...
        let newTableQuery = `CREATE TABLE ${newTableName} (id INT NOT NULL AUTO_INCREMENT, PRIMARY KEY (id))`;
        ...
        connection.query(selectDatabaseQuery, (err) => {
            ...
            connection.query(newTableQuery, (err, result) => {
                if (err) {
                ...
                console.log(`${bc.e_gray}(${bc.e_green}✔${bc.e_gray}) ${bc.e_green}Created new table: ${themes.secondary}${newTableName}${bc.end}${bc.end}`);
